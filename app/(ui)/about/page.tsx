    ...
    <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
      ...
      <div className="mt-12">
        <div className="text-lg leading-7 text-gray-600 space-y-4">
          <p>
            At YourFolio, we believe in the power of individual creativity and
            the immense potential it holds when given the right platform. Our
            mission is to democratize the creation of online portfolios, making
            it accessible, secure, and personalized for everyone, regardless of
            their technical skill level or financial capacity.
          </p>
          <p>
            ...
            individuals in the shadows. YourFolio aims to remove these barriers,
            offering a community-driven platform where every user can showcase
            their work confidently and securely at an affordable price.
          </p>
          <p>
